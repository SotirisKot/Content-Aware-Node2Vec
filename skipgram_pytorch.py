...
class SkipGram(nn.Module):
    ...
    def forward(self, pos_u, pos_v, neg_v):
        ...
        embed_v = embed_v.view(self.batch_size, 2 * self.window_size, self.embedding_dim)
        neg_embed_v = self.v_embeddings(neg_v)
        neg_embed_v = neg_embed_v.view(self.batch_size, self.neg_sample_num, self.embedding_dim)
